...
class CSWinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=101, embed_dim=96, depth=[2, 2, 6, 2],
                 split_size=[3, 5, 7],
        ...
        if self.hydra_heads_class_counts is not None:
            ...
            self.fc_out = nn.Linear(total_outputs_heads, 101, bias=False)
...
iccv_heads = []
iccv_heads.append(101)

cluster_df = pd.read_csv('Food101_clusters.csv', dtype='Int64')
